...
namespace AI_2048
{
    internal class Ai2048 : IAi2048, I2048MoveMaker
    {
        ...
        public Direction CalculateNextMove(Board2048 board2048)
        {
            ...
            {
                var moveValue = Expectimax(MakePlayerMove(dir, board2048), DEPTH, Move.Player);
                if (moveValue > max)
                {
                    max = moveValue;
                    bestDir = dir;
        ...
        private double Expectimax(Board2048 board, int depth, Move curMove)
        {
            if (depth <= 0)
        ...
        private static double StaticEvaluationFunction(Board2048 board)
        {
            ...
            return (double)board.Score / (board.Rows * board.Cols - board.GetFreeCellsCount());
        }
        ...
        public Board2048 MakePlayerMove(Direction dir, Board2048 board)
        {
            ...
            board.Score += score;
            board.IsMovePossible = movePossible;
            return board;
        }
